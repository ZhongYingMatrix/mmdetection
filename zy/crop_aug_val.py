...
def parse_args():
    ...
    parser.add_argument('--config', help='test config file path',
                        default='/home/zhongying/other/walkgis/mmdetection/zy/htc_new_set/2019_11_11/test_htc_dconv_c5_r101_fpn_sbn_20e_total.py')
    parser.add_argument('--checkpoint', help='checkpoint file',
                        default='/home/zhongying/other/walkgis/mmdetection/zy/htc_new_set/2019_11_13/epoch_100.pth')
    parser.add_argument('--root', help='output root', default='/home/zhongying/other/walkgis/mmdetection/zy/res/val_result/')
    parser.add_argument('--ann', help='annotation file', default='/home/zhongying/dataset/WalkValidationData/correct_validation_instance.json')
