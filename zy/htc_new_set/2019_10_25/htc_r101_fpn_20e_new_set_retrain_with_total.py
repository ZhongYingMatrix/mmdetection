...
data = dict(
    ...
    test=dict(
        ...
        ann_file=data_root + 'WalkTrainData/correct_xihu_instance.json',
        #ann_file=data_root + 'WalkTrainData/correct_cn_instance.json',
...
log_level = 'INFO'
work_dir = '/home/zhongying/other/walkgis/mmdetection/zy/htc_new_set/2019_10_25'
load_from = '/home/zhongying/other/walkgis/mmdetection/zy/htc_new_set/2019_10_24/epoch_20.pth'
resume_from = None
workflow = [('train', 1)]
